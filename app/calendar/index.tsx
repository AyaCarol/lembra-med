...
export default function CalendarScreen() {
  ...
  // Preenche a última semana com células vazias, se necessário
  if (week.length > 0) {
    while (week.length < 7) {
      week.push(
        <View key={`empty-end-${week.length}`} style={styles.calendarDay} />
      );
    }
    calendar.push(
        ...
        <View style={styles.calendarContainer}>
          <View style={styles.monthHeader}>
            ...
            <Text style={styles.monthText}>
              {selectedDate.toLocaleString("pt", {
                month: "long",
                year: "numeric",
              })}
            </Text>
